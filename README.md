...
- [Grams to Cups](https://gramstocups.io/) - Converts cooking weights to US cups by ingredient density across hundreds of pantry items. `Web` · **Price:** Free · **License:** Proprietary.
...
- [Days Calculator](https://dayscalculator.io/) - Count days between two dates or from today, plus add/subtract days. Runs in the browser. `Web` · **Price:** Free · **License:** Proprietary.
...
- [WattsCalc](https://wattscalc.com/) - Estimates appliance wattage and electricity cost from power, hours, and local rates. `Web` · **Price:** Free · **License:** Proprietary.
...
- [Embroidery Pricing Calculator](https://embroiderypricingcalculator.com/) - Prices embroidery jobs from stitches, fabric, and labor. `Web` · **Price:** Free · **License:** Proprietary.
